...
import { Brain, Leaf, Zap, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <section className="max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        >
          {isAuthenticated ? "Start Nieuwe Analyse" : "Start Je Gratis Analyse"}
        </Button>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="p-8 text-center border-0 shadow-md">
            ...
            <p className="text-gray-600">Beantwoord een uitgebreide vragenlijst over jouw klachten, leefstijl, voeding, slaap en geschiedenis. Hoe eerlijker, hoe beter het advies.</p>
          </Card>
          <Card className="p-8 text-center border-0 shadow-md">
            ...
            <p className="text-gray-600">Onze AI verbindt de verbanden tussen jouw klachten die anderen missen. Geen losse symptomen, maar een compleet beeld van wat er speelt in jouw lichaam.</p>
          </Card>
          <Card className="p-8 text-center border-0 shadow-md">
            ...
            <p className="text-gray-600">Je ontvangt een gedetailleerd rapport met de mogelijke oorzaken, een 6-maanden herstelplan, voedings- en supplementadviezen en concrete volgende stappen.</p>
          </Card>
        </div>
      </section>
      ...
      <section className="bg-indigo-50 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-2xl font-semibold text-gray-800 italic mb-4">"Geen diagnose, maar wel eindelijk begrip."</p>
          <p className="text-gray-600 max-w-2xl mx-auto">Wij stellen geen medische diagnoses. Wij helpen je begrijpen wat er mogelijk speelt in jouw lichaam — en bij wie je kunt aankloppen voor verdere hulp.</p>
        </div>
      </section>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">Klachten die vaak worden onderschat, maar jouw dagelijks leven enorm beïnvloeden.</p>
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-6 border-l-4 border-indigo-600">
              <h4 className="font-bold text-lg mb-2">Chronische Vermoeidheid</h4>
              <p className="text-gray-600 text-sm">Je bent uitgeput, ook na een nacht slapen. Je energieniveau is onverklaarbaar laag en niemand geeft je een antwoord. Wij zoeken naar de onderliggende oorzaken en geven je een stap-voor-stap plan om je energie terug te krijgen.</p>
            </Card>
            <Card className="p-6 border-l-4 border-green-600">
              <h4 className="font-bold text-lg mb-2">Spijsverterings­problemen</h4>
              <p className="text-gray-600 text-sm">Opgeblazen gevoel, darmklachten, voedselintoleranties of een gevoel dat je darmen nooit echt goed werken. Wij helpen je begrijpen hoe je darmgezondheid herstelt en je voeding optimaliseert.</p>
            </Card>
            <Card className="p-6 border-l-4 border-purple-600">
              ...
              <p className="text-gray-600 text-sm">Artsen vinden niets, maar jij voelt duidelijk dat er iets niet klopt. Wij verbinden de verbanden tussen jouw symptomen en helpen je begrijpen wat er werkelijk speelt.</p>
            </Card>
            <Card className="p-6 border-l-4 border-pink-600">
              <h4 className="font-bold text-lg mb-2">Auto-Immuun Gerelateerde Klachten</h4>
              <p className="text-gray-600 text-sm">Je immuunsysteem werkt tegen je. Wij helpen je begrijpen hoe je je lichaam kunt ondersteunen met holistische strategieën die werken naast de reguliere behandeling.</p>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        ...
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">Begin gratis. Betaal alleen als je meer wilt weten.</p>
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="p-6 border-2 border-green-500 bg-green-50">
            ...
            <p className="text-sm text-gray-600 mb-4">Jouw persoonlijke preview — eerste inzichten in wat er mogelijk speelt, zodat je eindelijk voelt dat iemand je begrijpt.</p>
            ...
            <Button onClick={handleStartAnamnesis} variant="outline" className="w-full">Start Gratis</Button>
          </Card>
          <Card className="p-6 border-2 border-indigo-600 bg-indigo-50 relative">
            <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-indigo-600 text-white text-xs px-3 py-1 rounded-full">Meest Gekozen</div>
            ...
            <p className="text-sm text-gray-600 mb-4">Jouw complete herstelplan — maand voor maand uitgewerkt met voeding, supplementen, leefstijl en concrete acties.</p>
            <ul className="text-sm text-gray-600 space-y-2 mb-6">
            ...
            <Button onClick={handleStartAnamnesis} className="w-full bg-indigo-600 hover:bg-indigo-700">Start Nu</Button>
          </Card>
          <Card className="p-6 border-2 border-purple-200 bg-purple-50">
            ...
            <p className="text-sm text-gray-600 mb-4">Wil je persoonlijk begeleid worden bij het uitvoeren van jouw plan? Neem contact op voor een gesprek.</p>
            <ul className="text-sm text-gray-600 space-y-2 mb-6">
            ...
            <Button onClick={() => window.location.href = 'mailto:info@holistischadviseur.nl'} className="w-full bg-purple-600 hover:bg-purple-700">Neem Contact Op</Button>
          </Card>
        </div>
      </section>
      ...
      <section className="bg-indigo-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 opacity-90">Start vandaag nog gratis. Binnen minuten weet je meer over jouw lichaam dan na jaren van zoeken.</p>
          <Button onClick={handleStartAnamnesis} size="lg" className="bg-white text-indigo-600 hover:bg-gray-100 px-8 py-6 text-lg font-semibold">
      ...
      <footer className="bg-gray-900 text-white py-10">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-gray-400 font-medium mb-1">© {new Date().getFullYear()} Holistisch AI Kliniek. Alle rechten voorbehouden.</p>
          <p className="text-gray-500 text-sm mb-6">info@holistischadviseur.nl</p>
