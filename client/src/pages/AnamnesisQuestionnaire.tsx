...
// VERBETERD: van ~42 naar ~28 vragen, slimmer en meer open, betere UX
...
const STORAGE_KEY = "anamnesis_draft_v3";
...
const ALL_QUESTIONS: Question[] = [
  ...
  {
    id: "main_complaint",
    label: "Beschrijf in je eigen woorden wat je het meest dwars zit.",
    sublabel: "Neem de tijd — hoe meer je deelt, hoe persoonlijker het rapport.",
    type: "textarea",
    section: "basic_info",
  },
  {
    id: "duration",
    label: "Hoe lang heb je deze klachten al, en was er een aanleiding?",
    sublabel: "Bijv: '8 maanden, na COVID' of '3 jaar, geleidelijk ontstaan'",
    type: "textarea",
    section: "basic_info",
  },
  ...
  {
    id: "sleep_quality",
    label: "Hoe goed slaap je over het algemeen? Geef een cijfer van 1 tot 10.",
    sublabel: "1 = heel slecht, 10 = uitstekend en uitgerust wakker",
    type: "scale",
    section: "sleep",
  },
  {
    id: "sleep_issues",
    label: "Wat zijn je slaapproblemen, als je die hebt?",
    sublabel: "Moeilijk inslapen, wakker worden, niet uitgerust wakker — of schrijf 'geen problemen'",
    type: "textarea",
    section: "sleep",
    optional: true,
  },
  ...
  {
    id: "diet_type",
    label: "Hoe zou je je eetpatroon omschrijven?",
    type: "select",
    options: ["Ik eet alles", "Vegetarisch", "Veganistisch", "Keto / low-carb", "Anders"],
    section: "nutrition",
  },
  {
    id: "gut_issues",
    label: "Heb je last van je buik of darmen? Beschrijf wat je ervaart.",
    sublabel: "Denk aan: opgeblazen gevoel, pijn, wisselende stoelgang, krampen",
    type: "textarea",
    section: "nutrition",
    optional: true,
  },
  {
    id: "food_triggers",
    label: "Zijn er voedingsmiddelen die je klachten lijken te verergeren of verbeteren?",
    sublabel: "Schrijf alles op wat je opvalt — ook vermoedens tellen",
    type: "textarea",
    section: "nutrition",
    optional: true,
  },
  ...
  {
    id: "exercise",
    label: "Hoeveel uur per week beweeg je actief?",
    sublabel: "Sport, wandelen, fietsen — alles telt mee",
    type: "number",
    section: "lifestyle",
  },
  {
    id: "stress_level",
    label: "Hoeveel stress ervaar je op dit moment? Geef een cijfer van 1 tot 10.",
    sublabel: "1 = nauwelijks stress, 10 = extreme stress",
    type: "scale",
    section: "lifestyle",
  },
  {
    id: "stress_sources",
    label: "Waar komt die stress vandaan en hoe lang speelt dit al?",
    sublabel: "Werk, relaties, gezondheid, financiën — alles is relevant",
    type: "textarea",
    section: "lifestyle",
    showIf: (r) => parseInt(r.stress_level) >= 4,
  },

  // ── MENTAAL & EMOTIONEEL (3 vragen) ──
  {
    id: "mental_clarity",
    label: "Hoe helder voelt je hoofd overdag? Geef een cijfer van 1 tot 10.",
    sublabel: "1 = veel hersenmist / moeite met focussen, 10 = super scherp",
    type: "scale",
    section: "emotional",
  },
  {
    id: "anxiety",
    label: "Heb je last van angst, paniekaanvallen of een aanhoudend onrustig gevoel?",
    type: "select",
    options: ["Ja, regelmatig of ernstig", "Soms", "Zelden", "Nooit"],
    section: "emotional",
  },
  {
    id: "emotional_description",
    label: "Hoe voel je je emotioneel in het dagelijks leven?",
    sublabel: "Beschrijf wat er speelt — denk aan stemmingswisselingen, somberheid, overprikkeling",
    type: "textarea",
    section: "emotional",
    optional: true,
  },
  ...
  {
    id: "medications",
    label: "Welke medicijnen of supplementen gebruik je op dit moment?",
    sublabel: "Schrijf 'geen' als je niets gebruikt",
    type: "textarea",
    section: "medical",
  },
  {
    id: "allergies",
    label: "Heb je allergiën, voedselintoleranties of bekende medische aandoeningen?",
    sublabel: "Schrijf 'geen' als er niets bekend is",
    type: "textarea",
    section: "medical",
  },
  {
    id: "past_treatments",
    label: "Wat heb je al geprobeerd om je klachten te verbeteren?",
    sublabel: "Arts, specialist, dieet, therapie, supplementen — alles helpt ons beter adviseren",
    type: "textarea",
    section: "medical",
    optional: true,
  },

  // ── CONDITIE: CHRONIC FATIGUE (4 vragen) ──
  {
    id: "post_exertional_malaise",
    label: "Word je erger na een inspanning — ook na lichte activiteit?",
    sublabel: "Bijv. na een wandeling, een drukke dag of een gesprek",
    type: "select",
    options: ["Ja, altijd — soms dagen later", "Soms", "Zelden", "Nee"],
    section: "condition_specific",
    showIf: (_, ct) => ct === "chronic_fatigue",
  },
  {
    id: "viral_history",
    label: "Heb je ooit een ernstige infectie gehad waarna je nooit meer helemaal hersteld bent?",
    sublabel: "Zoals COVID, klierkoorts (EBV), de ziekte van Lyme",
    type: "select",
    options: ["Ja, bevestigd", "Mogelijk, ik vermoed het", "Nee", "Weet ik niet"],
    section: "condition_specific",
    showIf: (_, ct) => ct === "chronic_fatigue",
  },
  {
    id: "sleep_restful",
    label: "Voel je je uitgerust na een nacht slaap?",
    type: "select",
    options: ["Nooit — ik word altijd moe wakker", "Zelden", "Soms", "Meestal wel"],
    section: "condition_specific",
    showIf: (_, ct) => ct === "chronic_fatigue",
  },
  {
    id: "fatigue_extra",
    label: "Beschrijf hoe de vermoeidheid je dagelijks leven beïnvloedt.",
    sublabel: "Wat kun je niet meer doen wat je vroeger wel kon?",
    type: "textarea",
    section: "condition_specific",
    showIf: (_, ct) => ct === "chronic_fatigue",
  },

  // ── CONDITIE: DIGESTIVE ISSUES (4 vragen) ──
  {
    id: "bowel_pattern",
    label: "Hoe is je stoelgang doorgaans?",
    type: "select",
    options: ["Hard en moeilijk", "Normaal", "Zacht en los", "Diarree", "Wisselend"],
    section: "condition_specific",
    showIf: (_, ct) => ct === "digestive_issues",
  },
  {
    id: "antibiotic_history",
    label: "Heb je in het verleden meerdere kuren antibiotica gehad?",
    type: "select",
    options: ["Ja, meerdere kuren", "Ja, één keer", "Nee", "Weet ik niet"],
    section: "condition_specific",
    showIf: (_, ct) => ct === "digestive_issues",
  },
  {
    id: "stress_gut_relation",
    label: "Merk je een verband tussen stress en je buikklachten?",
    type: "select",
    options: ["Ja, duidelijk verband", "Soms", "Geen verband", "Weet ik niet"],
    section: "condition_specific",
    showIf: (_, ct) => ct === "digestive_issues",
  },
  {
    id: "gut_extra",
    label: "Beschrijf een typische slechte dag qua spijsvertering.",
    sublabel: "Wanneer begint het, hoe voelt het, wat maakt het erger of beter?",
    type: "textarea",
    section: "condition_specific",
    showIf: (_, ct) => ct === "digestive_issues",
  },

  // ── CONDITIE: SOLK (4 vragen) ──
  {
    id: "symptom_locations",
    label: "Waar in je lichaam voel je klachten, en hoe voelen ze aan?",
    sublabel: "Beschrijf alle plekken en sensaties zo concreet mogelijk",
    type: "textarea",
    section: "condition_specific",
    showIf: (_, ct) => ct === "solk",
  },
  {
    id: "stress_symptoms_relation",
    label: "Worden je klachten erger als je gestrest of angstig bent?",
    type: "select",
    options: ["Ja, duidelijk", "Soms", "Nee", "Weet ik niet"],
    section: "condition_specific",
    showIf: (_, ct) => ct === "solk",
  },
  {
    id: "trauma_history",
    label: "Heb je ingrijpende ervaringen meegemaakt die mogelijk verband houden met je klachten?",
    sublabel: "Je hoeft niets te vertellen wat je niet wilt — elk antwoord is goed",
    type: "select",
    options: ["Ja, wil ik toelichten", "Mogelijk", "Nee"],
    section: "condition_specific",
    showIf: (_, ct) => ct === "solk",
  },
  {
    id: "trauma_details",
    label: "Als je wilt, beschrijf kort wat er is gebeurd en hoe dat je beïnvloedt.",
    type: "textarea",
    section: "condition_specific",
    showIf: (r, ct) => ct === "solk" && r.trauma_history === "Ja, wil ik toelichten",
    optional: true,
  },

  // ── CONDITIE: AUTO-IMMUUN (4 vragen) ──
  {
    id: "autoimmune_condition",
    label: "Welke auto-immuunaandoening heb je of vermoed je?",
    sublabel: "Bijv: hashimoto, lupus, reuma, MS, coeliakie — of beschrijf je vermoedens",
    type: "textarea",
    section: "condition_specific",
    showIf: (_, ct) => ct === "auto_immuun",
  },
  {
    id: "histamine_symptoms",
    label: "Krijg je na bepaalde voeding klachten zoals hoofdpijn, huiduitslag of hartkloppingen?",
    type: "select",
    options: ["Ja, regelmatig", "Soms", "Zelden", "Nee"],
    section: "condition_specific",
    showIf: (_, ct) => ct === "auto_immuun",
  },
  {
    id: "joint_muscle_pain",
    label: "Heb je last van gewrichts- of spierpijn?",
    type: "select",
    options: ["Ja, ernstig", "Matig", "Licht", "Nee"],
    section: "condition_specific",
    showIf: (_, ct) => ct === "auto_immuun",
  },
  {
    id: "autoimmune_extra",
    label: "Beschrijf hoe je klachten dagelijks verlopen en wat ze beïnvloedt.",
    sublabel: "Wat maakt het beter of slechter? Seizoenen, stress, voeding, slaap?",
    type: "textarea",
    section: "condition_specific",
    showIf: (_, ct) => ct === "auto_immuun",
  },

  // ── CONDITIE: ALK (4 vragen) ──
  {
    id: "main_symptoms_alk",
    label: "Beschrijf al je klachten zo volledig mogelijk.",
    sublabel: "Locatie, soort pijn, wanneer, hoe lang al — alles helpt",
    type: "textarea",
    section: "condition_specific",
    showIf: (_, ct) => ct === "alk",
  },
  {
    id: "symptom_pattern_alk",
    label: "Zijn de klachten constant of wisselend?",
    type: "select",
    options: ["Constant aanwezig", "Wisselend", "In aanvallen", "Seizoensgebonden"],
    section: "condition_specific",
    showIf: (_, ct) => ct === "alk",
  },
  {
    id: "lifestyle_impact",
    label: "Hoe beïnvloeden de klachten je dagelijks leven?",
    sublabel: "Werk, sociale contacten, sport, huishouden — wat kun je niet meer?",
    type: "textarea",
    section: "condition_specific",
    showIf: (_, ct) => ct === "alk",
  },
  {
    id: "alk_triggers",
    label: "Wat maakt je klachten erger of beter?",
    sublabel: "Beweging, rust, stress, voeding, temperatuur — alles telt",
    type: "textarea",
    section: "condition_specific",
    showIf: (_, ct) => ct === "alk",
    optional: true,
  ...
  {
    id: "primary_goal",
    label: "Wat wil jij het allerliefst bereiken met dit programma?",
    sublabel: "Hoe concreter, hoe beter — dit bepaalt hoe persoonlijk je rapport wordt",
    type: "textarea",
    section: "goals",
  },
  {
    id: "commitment",
    label: "Hoe gemotiveerd ben je om echt iets te veranderen? Geef een cijfer van 1 tot 10.",
    sublabel: "1 = ik twijfel nog, 10 = ik ben er helemaal klaar voor",
    type: "scale",
    section: "goals",
  },
];
    ...
    <div className="space-y-5">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-500 mt-1 text-sm">
          Klik op een antwoord om het aan te passen.
        </p>
      </div>
                ...
                >
                  ...
                  <div className="font-medium text-gray-800 text-sm">
                    {val !== undefined && val !== null && val !== "" ? (
                      String(val).length > 120 ? String(val).substring(0, 120) + "..." : String(val)
                    ) : (
                      <span className="text-gray-300 italic">
                        {q.optional ? "Overgeslagen" : "Niet ingevuld"}
                      </span>
                    )}
                  </div>
                </button>
  ...
  useEffect(() => {
    ...
    try {
      localStorage.setItem(
        STORAGE_KEY,
        JSON.stringify({ conditionType, responses, step, currentQ })
      );
    } catch {}
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center z-50">
        <div className="bg-white rounded-2xl shadow-xl p-10 max-w-md w-full mx-4 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-3">
            Je rapport wordt gemaakt
          </h2>
          <p className="text-gray-500 mb-6 text-sm leading-relaxed">
            Onze AI analyseert jouw antwoorden en stelt een persoonlijk holistisch
            rapport op. Dit duurt 15–30 seconden.
          </p>
          ...
          <div>
            <div className="mb-8">
              ...
              <p className="text-gray-500 leading-relaxed">
                Om een persoonlijk rapport te maken, beginnen we met het ziektebeeld
